...
def cmd_segvir_polish():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True, 
        help="Directory to store results. If exists, the results in directory will be repleace if set `overwrite` as True.\
    ...
    parser.add_argument(
        ...
        type=bool,
        default=False,
        help="Overwrite the results in the output directory (default: False)."
        )
