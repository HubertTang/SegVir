...
def segvir_parse_rst(contig_path, ref_dir, temp_dir, blastp_evalue=1e-5, hmmer_evalue=1e-5, host_ratio_thres=0.84,
                     rdrp_evalue=1e-10, rdrp_len=900, vote_thres=0.85):
...
if __name__ == "__main__":
    ...
    segvir_parse_rst(contig_path=input_contig, ref_dir=ref_db_path, temp_dir=temp_dir, 
                     blastp_evalue=segvir_args.blastp, hmmer_evalue=segvir_args.hmmer, host_ratio_thres=0.5,
                     rdrp_evalue=segvir_args.rdrp_evalue, rdrp_len=segvir_args.rdrp_len, vote_thres=segvir_args.vote_thres)
